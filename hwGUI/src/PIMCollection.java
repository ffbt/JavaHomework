...
public class PIMCollection implements Collection
{
    ...
    public Collection getNotes()
    {
        ...
        {
            if (pimEntity instanceof PIMNote && pimEntity.isPublic())
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getNotes(String owner)
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMNote && owner.equals(pimEntity.getOwner()))
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getTodos()
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMTodo && pimEntity.isPublic())
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getTodos(String owner)
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMTodo && owner.equals(pimEntity.getOwner()))
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getAppointments()
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMAppointment && pimEntity.isPublic())
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getAppointments(String owner)
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMAppointment && owner.equals(pimEntity.getOwner()))
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getContacts()
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMContact && pimEntity.isPublic())
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getContacts(String owner)
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof PIMContact && owner.equals(pimEntity.getOwner()))
                list.add(pimEntity);
        }
        return list;
    }
    ...
    public Collection getItemsForDate(Date d)
    {
        ...
        for (PIMEntity pimEntity : pimEntities)
        {
            if (pimEntity instanceof Dateable && pimEntity.isPublic() && ((Dateable) pimEntity).getDate().equals(date))
                list.add(pimEntity);
        }
        return list;
    }

    public Collection getItemsForDate(Date d, String owner)
    {
        ArrayList list = new ArrayList();
        SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy");
        String date = sdf.format(d);
        for (PIMEntity pimEntity : pimEntities)
        {
            if(pimEntity instanceof Dateable && ((Dateable)pimEntity).getDate().equals(date) && owner.equals(pimEntity.getOwner()))
                list.add(pimEntity);
        }
        return list;
    }
